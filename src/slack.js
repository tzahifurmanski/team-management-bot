...
var BOT_TEST_CHANNEL = config.UNICORN_BOT_CHANNEL_ID;
var token = config.BOT_USER_OAUTH_ACCESS_TOKEN;
console.log("Token", config.BOT_USER_OAUTH_ACCESS_TOKEN);
var createEventAdapter = require("@slack/events-api").createEventAdapter;
var slackSigningSecret = config.SLACK_SIGNING_SECRET;
exports.slackEvents = createEventAdapter(slackSigningSecret);
exports.slackEvents.on("message", function (event) {
    // Oops! This throws a TypeError.
    event.notAMethod();
});
// All errors in listeners are caught here. If this weren't caught, the program would terminate.
exports.slackEvents.on("error", function (error) {
...
exports.sendSlackMessage = function (text) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, web.chat.postMessage({
                        text: text,
